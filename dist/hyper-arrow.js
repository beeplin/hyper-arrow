    ...
    return new PROXY(obj, {
        get(obj, prop) {
            ...
            if (currentArrow) {
                ...
                if (!arrow2ropa.has(currentArrow))
                    arrow2ropa.set(currentArrow, new WeakMap());
                const ropaMap = arrow2ropa.get(currentArrow);
                if (!(ropaMap === null || ropaMap === void 0 ? void 0 : ropaMap.has(obj)))
                    ropaMap === null || ropaMap === void 0 ? void 0 : ropaMap.set(obj, new Set());
                (_a = ropaMap === null || ropaMap === void 0 ? void 0 : ropaMap.get(obj)) === null || _a === void 0 ? void 0 : _a.add(prop);
                // build reverse deps for debugging purpose
                if (!ropa2arrow.has(obj))
                    ropa2arrow.set(obj, OBJECT.create(null));
        ...
        deleteProperty(obj, prop) {
            ...
            // console.log('--delete--')
            // console.log(obj, prop)
            for (const ropaMap of arrow2ropa.values())
                (_a = ropaMap.get(obj)) === null || _a === void 0 ? void 0 : _a.delete(prop);
            (_b = ropa2arrow.get(obj)) === null || _b === void 0 ? true : delete _b[prop];
            return result;
        },
    });
}
