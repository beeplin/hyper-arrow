...
import { CACHE_REMOVED_CHILDREN, CHILDREN, debug, fac2opas, isReactive, mount, ON_CREATE, PROPS, reactive, TAG, tags, TYPE, UID_ATTR_NAME, uidAttr, VEl, watch, } from './hyper-arrow';
...
describe('hyper-arrow', () => {
    ...
    describe('mount function', () => {
        it('should mount virtual element to DOM', () => {
            ...
            expect(mountedEl === null || mountedEl === void 0 ? void 0 : mountedEl.textContent).toBe('Hello');
        });
    ...
    describe('watch function', () => {
        it('should return cleanup function', () => {
            const data = reactive({ count: 0 });
            let triggerCount = 0;
            const cleanup = watch(() => data.count, () => {
                triggerCount++;
            });
            data.count = 1;
            cleanup();
    ...
    describe('caching system', () => {
        it('should reuse cached elements when re-adding children', async () => {
            ...
            expect(parent === null || parent === void 0 ? void 0 : parent.children.length).toBe(2);
            // Remove children
            children.length = 0;
            await Promise.resolve();
            expect(parent === null || parent === void 0 ? void 0 : parent.children.length).toBe(0);
    ...
    describe('UID_ATTR_NAME feature', () => {
        it('should add uids to elements when UID_ATTR_NAME is specified', () => {
            ...
            expect(parent === null || parent === void 0 ? void 0 : parent.getAttribute('data-uid')).toBeDefined();
            expect(child1 === null || child1 === void 0 ? void 0 : child1.getAttribute('data-uid')).toBeDefined();
            expect(child2 === null || child2 === void 0 ? void 0 : child2.getAttribute('data-uid')).toBeDefined();
            // IDs should be unique
            expect(parent === null || parent === void 0 ? void 0 : parent.getAttribute('data-uid')).not.toBe(child1 === null || child1 === void 0 ? void 0 : child1.getAttribute('data-uid'));
            expect(child1 === null || child1 === void 0 ? void 0 : child1.getAttribute('data-uid')).not.toBe(child2 === null || child2 === void 0 ? void 0 : child2.getAttribute('data-uid'));
            expect(parent === null || parent === void 0 ? void 0 : parent.getAttribute('data-uid')).not.toBe(child2 === null || child2 === void 0 ? void 0 : child2.getAttribute('data-uid'));
        });
        it('should not add uid attrs when UID_ATTR_NAME is not specified', () => {
            ...
            expect(parent === null || parent === void 0 ? void 0 : parent.getAttribute('data-uid')).toBeNull();
            expect(child === null || child === void 0 ? void 0 : child.getAttribute('data-uid')).toBeNull();
        });
        it('should increment uid values for each new element', () => {
            ...
            const firstUid = (_a = document
                .querySelector('#first')) === null || _a === void 0 ? void 0 : _a.getAttribute('data-uid');
            const appElement = document.querySelector('#app');
            if (appElement)
                appElement.innerHTML = '';
            mount('#app', vel2, { [UID_ATTR_NAME]: 'data-uid' });
            const secondUid = (_b = document
                .querySelector('#second')) === null || _b === void 0 ? void 0 : _b.getAttribute('data-uid');
    ...
    describe('dom events', () => {
        it('should handle onclick events', () => {
            ...
            buttonEl === null || buttonEl === void 0 ? void 0 : buttonEl.click();
        ...
        it('should handle mixed case events', () => {
            ...
            const buttonEl = document.querySelector('button');
            buttonEl === null || buttonEl === void 0 ? void 0 : buttonEl.click();
            buttonEl === null || buttonEl === void 0 ? void 0 : buttonEl.dispatchEvent(new MouseEvent('mousedown'));
            buttonEl === null || buttonEl === void 0 ? void 0 : buttonEl.dispatchEvent(new MouseEvent('mouseup'));
            expect(onClick).toHaveBeenCalledTimes(1);
    ...
    describe('DOM elements with children', () => {
        it('should handle elements with no attributes, only children', () => {
            ...
            const attributes = pEl === null || pEl === void 0 ? void 0 : pEl.attributes;
            expect(attributes === null || attributes === void 0 ? void 0 : attributes.length).toBe(0);
            expect(pEl === null || pEl === void 0 ? void 0 : pEl.children.length).toBe(2);
            expect(pEl === null || pEl === void 0 ? void 0 : pEl.childNodes.length).toBe(3);
            expect(pEl === null || pEl === void 0 ? void 0 : pEl.children[0].tagName.toLowerCase()).toBe('span');
            expect(pEl === null || pEl === void 0 ? void 0 : pEl.children[0].textContent).toBe('First');
            expect(pEl === null || pEl === void 0 ? void 0 : pEl.children[1].tagName.toLowerCase()).toBe('p');
            expect(pEl === null || pEl === void 0 ? void 0 : pEl.children[1].textContent).toBe('Second');
            expect(pEl === null || pEl === void 0 ? void 0 : pEl.childNodes[2].nodeType).toBe(3); // Text node
            expect(pEl === null || pEl === void 0 ? void 0 : pEl.childNodes[2].textContent).toBe('Text node');
        });
    });
    describe('style properties', () => {
        it('should handle style properties with $ prefix', () => {
            ...
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.getPropertyValue('color')).toBe('red');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.getPropertyValue('background-color')).toBe('blue');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.getPropertyValue('font-size')).toBe('16px');
        });
        it('should handle dynamic style properties', () => {
            ...
            const divEl = document.querySelector('div');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.getPropertyValue('color')).toBe('red');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.getPropertyValue('padding')).toBe('10px');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.getPropertyValue('background-color')).toBe('yellow');
            data.color = 'blue';
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.getPropertyValue('color')).toBe('blue');
        });
        it('should remove style properties when value is null or undefined', () => {
            ...
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.getPropertyValue('color')).toBe('');
        });
    });
    describe('reactive arrays', () => {
        ...
        it('should handle deeply nested reactive arrays', () => {
            ...
            const vel = ul(() => data.nested.items.map((item) => li({ id: item.id.toString() }, item.text)));
            mount('#app', vel);
            const lis = document.querySelectorAll('li');
    ...
    describe('special properties', () => {
        it('should handle attributes with _ prefix', () => {
            ...
            mount('#app', vel);
            const divEl = document.querySelector('div');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.getAttribute('custom-attr')).toBe('test');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.getAttribute('data')).toBe('123');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.getAttribute('complex_multi_word_attr')).toBe('value');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.getAttribute('my-custom-complex-attr')).toBe('camelCase');
        });
        it('should handle camelCase to kebab-case conversion', () => {
            ...
            mount('#app', vel);
            const divEl = document.querySelector('div');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.getAttribute('data-test-id')).toBe('test');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.getAttribute('aria-label')).toBe('label');
        });
    });
    describe('textContent and innerHTML', () => {
        it('should handle textContent property', () => {
            ...
            mount('#app', vel);
            const divEl = document.querySelector('div');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.textContent).toBe('hello');
            data.text = 'world';
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.textContent).toBe('world');
        });
        it('should handle innerHTML property', () => {
            ...
            mount('#app', vel);
            const divEl = document.querySelector('div');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.innerHTML).toBe('<span>test</span>');
            data.html = '<p>changed</p>';
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.innerHTML).toBe('<p>changed</p>');
        });
    });
    ...
    describe('MathML and SVG elements', () => {
        it('should create and update MathML elements', () => {
            ...
            const vel = math(mfrac(mi('x'), mn(() => data.value.toString())));
            mount('#app', vel);
            const mathEl = document.querySelector('math');
            expect(mathEl).not.toBeNull();
            expect(mathEl === null || mathEl === void 0 ? void 0 : mathEl.namespaceURI).toBe('http://www.w3.org/1998/Math/MathML');
            const mnEl = document.querySelector('mn');
            expect(mnEl === null || mnEl === void 0 ? void 0 : mnEl.textContent).toBe('10');
            data.value = 20;
            expect(mnEl === null || mnEl === void 0 ? void 0 : mnEl.textContent).toBe('20');
        });
        it('should handle nested SVG elements with attributes', () => {
            ...
            const vel = svg({ width: '100', height: '100' }, g({ transform: 'translate(50,50)' }, circle({
                r: () => data.radius.toString(),
                fill: () => data.color,
            }), path({ d: 'M0,0L10,10' })));
            mount('#app', vel);
            const svgEl = document.querySelector('svg');
            expect(svgEl === null || svgEl === void 0 ? void 0 : svgEl.namespaceURI).toBe('http://www.w3.org/2000/svg');
            const circleEl = document.querySelector('circle');
            expect(circleEl === null || circleEl === void 0 ? void 0 : circleEl.getAttribute('r')).toBe('5');
            expect(circleEl === null || circleEl === void 0 ? void 0 : circleEl.getAttribute('fill')).toBe('red');
            data.radius = 10;
            data.color = 'blue';
            expect(circleEl === null || circleEl === void 0 ? void 0 : circleEl.getAttribute('r')).toBe('10');
            expect(circleEl === null || circleEl === void 0 ? void 0 : circleEl.getAttribute('fill')).toBe('blue');
        });
    });
    ...
    describe('complex children updates', () => {
        it('should handle conditional children rendering', () => {
            ...
            mount('#app', vel);
            expect((_a = document.querySelector('p')) === null || _a === void 0 ? void 0 : _a.textContent).toBe('Visible');
            ...
            data.show = true;
            data.items.push('d');
            expect((_b = document.querySelector('p')) === null || _b === void 0 ? void 0 : _b.textContent).toBe('Visible');
    ...
    describe('utility functions and edge cases', () => {
        ...
        it('should handle cache management with non-unique ids', () => {
            ...
            const vel = div({ [CACHE_REMOVED_CHILDREN]: 2 }, () => data.items.map((item) => div({ id: item.id }, item.text)));
            mount('#app', vel);
        ...
        it('should handle special attribute cases', () => {
            ...
            mount('#app', vel);
            const divEl = document.querySelector('div');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.getAttribute('data-test')).toBe('test');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('role')).toBe(false);
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('aria-label')).toBe(false);
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.className).toBe('visible');
            data.show = false;
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.className).toBe('');
        });
    ...
    describe('property handling', () => {
        it('should properly unset properties from elements', () => {
            ...
            const divEl = document.querySelector('div');
            // Initial state check
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.id).toBe('test-id');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.className).toBe('test-class');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.title).toBe('Test Title');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.innerText).toBe('text');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.getAttribute('data-custom')).toBe('custom');
            // Trigger property removal
            data.show = false;
            // Verify properties are removed
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('id')).toBe(false);
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('class')).toBe(false);
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('title')).toBe(false);
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('innertext')).toBe(false);
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('data-custom')).toBe(false);
        });
        it('should handle special property unset cases', () => {
            ...
            const divEl = document.querySelector('div');
            // Initial state check
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.color).toBe('red');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.backgroundColor).toBe('blue');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.getAttribute('aria-label')).toBe('test');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.innerText).toBe('text');
            // Trigger property removal
            data.props = false;
            // Verify properties are removed
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('style')).toBe(false);
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.backgroundColor).toBe('');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('aria-label')).toBe(false);
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.innerText).toBe('');
        });
        it('should handle unset props with reactive arrays', () => {
            const data = reactive({ items: ['a', 'b', 'c'] });
            const vel = ul(() => data.items.map((item) => li({
                'data-value': () => item,
        ...
        it('should handle unset props with multiple reactive dependencies', () => {
            ...
            mount('#app', vel);
            const divEl = document.querySelector('div');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.getAttribute('data-test')).toBe('one-two');
            data.condition1 = false;
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('data-test')).toBe(false);
            data.condition1 = true;
            data.condition2 = false;
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('data-test')).toBe(false);
            data.condition2 = true;
            data.value1 = 'new';
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.getAttribute('data-test')).toBe('new-two');
        });
        it('should handle unset props with computed values', () => {
            ...
            mount('#app', vel);
            const divEl = document.querySelector('div');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('class')).toBe(true);
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.className).toBe('over');
            data.numbers.pop();
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('class')).toBe(false);
            data.threshold = 2;
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.className).toBe('over');
        ...
        it('should handle unset props with conditional CSS classes', () => {
            ...
            mount('#app', vel);
            const divEl = document.querySelector('div');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.className).toBe('active pending');
            data.isActive = false;
            data.isPending = false;
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('class')).toBe(false);
            data.isDisabled = true;
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.className).toBe('disabled');
        });
        it('should handle unset props with nested objects', () => {
            ...
            const vel = div({
                style: () => data.theme.enabled
                    ? `color: ${data.styles.color}; font-size: ${data.styles.fontSize}`
                    : undefined,
                class: () => data.theme.enabled ? `theme-${data.theme.primary}` : undefined,
            });
            mount('#app', vel);
            const divEl = document.querySelector('div');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.color).toBe('red');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.fontSize).toBe('14px');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.className).toBe('theme-blue');
            data.theme.enabled = false;
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('style')).toBe(false);
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.hasAttribute('class')).toBe(false);
            data.theme.enabled = true;
            data.styles.color = 'green';
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.style.color).toBe('green');
            expect(divEl === null || divEl === void 0 ? void 0 : divEl.className).toBe('theme-blue');
        });
    });
    describe('debug mode console output', () => {
        ...
        it('should log element creation and mounting', () => {
            ...
            expect(consoleSpy.mock.calls.some((call) => call[0] === '+ prop' &&
                call[1] === 'div-#test' &&
                call[2] === 'id' &&
                call[3] === '=' &&
                call[4] === 'test')).toBe(true);
        });
        it('should log style property changes', () => {
            ...
            mount('#app', vel);
            data.color = 'green';
            expect(consoleSpy.mock.calls.some((call) => call[0] === '+ styl' &&
                call[1] === 'div-#' &&
                call[2] === '$color' &&
                call[3] === '=' &&
                call[4] === 'red')).toBe(true);
            expect(consoleSpy.mock.calls.some((call) => call[0] === '* styl' &&
                call[1] === 'div-#' &&
                call[2] === '$color' &&
                call[3] === ':' &&
                call[4] === 'red' &&
                call[5] === '->' &&
                call[6] === 'green')).toBe(true);
        });
        it('should log cache operations for arrays', () => {
            const data = reactive({ items: ['a', 'b'] });
            const vel = div({ [CACHE_REMOVED_CHILDREN]: 2 }, () => data.items.map((item) => div({ id: item }, item)));
            mount('#app', vel);
            data.items.splice(0, 1);
            expect(consoleSpy.mock.calls.some((call) => {
                var _a;
                return call[0] === 'remove' &&
                    call[1].includes('div-#') &&
                    ((_a = call[6]) === null || _a === void 0 ? void 0 : _a.includes('cache'));
            })).toBe(true);
        });
    });
    describe('array operations and caching', () => {
        it('should handle array splice operations with caching', () => {
            const data = reactive({ items: ['a', 'b', 'c'] });
            const vel = div({ [CACHE_REMOVED_CHILDREN]: 3 }, () => data.items.map((item, index) => div({ id: `item-${index}` }, item)));
            mount('#app', vel);
            data.items.splice(1, 1, 'x', 'y');
            expect(document.querySelectorAll('div > div').length).toBe(4);
            expect(Array.from(document.querySelectorAll('div > div')).map((el) => el.textContent)).toEqual(['a', 'x', 'y', 'c']);
        });
        it('should handle deeply nested array operations', () => {
            ...
            const vel = div(() => data.groups.map((group) => div({ id: `group-${group.id}` }, group.items.map((item) => span(item)))));
            mount('#app', vel);
            data.groups[0].items.push('x');
            expect((_a = document.querySelector('#group-1')) === null || _a === void 0 ? void 0 : _a.children.length).toBe(3);
            data.groups[1].items.unshift('y');
            expect((_b = document.querySelector('#group-2')) === null || _b === void 0 ? void 0 : _b.children.length).toBe(3);
        });
    });
    describe('string conversion and mapping', () => {
        it('should handle complex string transformations', () => {
            ...
            mount('#app', vel);
            expect((_a = document.querySelector('div')) === null || _a === void 0 ? void 0 : _a.getAttribute('data-complex')).toBe('test');
        });
        it('should handle array mapping with multiple transformations', () => {
            ...
            mount('#app', vel);
            expect(Array.from(document.querySelectorAll('li')).map((el) => el.textContent)).toEqual(['A', 'B']);
        });
    });
    describe('edge case coverage', () => {
        ...
        it('should handle property proxy edge cases', () => {
            ...
            const vel = div({
                [Object.getOwnPropertyNames(CustomElement.prototype)[0]]: () => data.show ? data.props.value : undefined,
            });
            mount('#app', vel);
            data.show = false;
        });
        it('should handle cache with complex key scenarios', () => {
            ...
            const vel = div({ [CACHE_REMOVED_CHILDREN]: 2 }, () => data.items.map((item) => div({
                id: item.id.toString(),
                [Symbol('test')]: 'test',
            }, item.text)));
            mount('#app', vel);
    ...
    describe('manually created', () => {
        it('should handle noop update doing nothing', () => {
            ...
            expect(el === null || el === void 0 ? void 0 : el.id).toBe('1');
            debug();
        ...
        it('should update deps when update one el child', () => {
            ...
            mount('#app', ul(li({ id: '1' }, () => s[0]), () => (s[1] ? li({ id: '2' }, () => s[1]) : li({ id: '2' }, 'empty'))));
        ...
        it('should update deps when update el children', () => {
            ...
            mount('#app', ul(li({ id: '1' }, () => s.list[0]), () => s.list[1]
                ? li({ id: '2' }, () => s.list[1])
                : li({ id: '2' }, 'empty')));
            expect(fac2opas.size).toBe(3);
            s.list = ['a'];
        ...
        it('should correctly update dynamic children', () => {
            ...
            mount('#app', div(() => p(s.prop, 'a'), () => (s.show ? 'b' : span('c'))));
            const el = document.querySelector('p');
            expect(el === null || el === void 0 ? void 0 : el.id).toBe('1');
            expect(el === null || el === void 0 ? void 0 : el.innerText).toBe('a');
            // @ts-ignore
            s.prop = { innerText: 'b' };
            expect(el === null || el === void 0 ? void 0 : el.id).toBe('');
            expect(el === null || el === void 0 ? void 0 : el.innerText).toBe('b');
            s.show = false;
            expect((_a = document.querySelector('span')) === null || _a === void 0 ? void 0 : _a.innerText).toBe('c');
        });
        it('should insert child from cache and log it', () => {
            debug();
            const s = reactive({ list: ['a'] });
            mount('#app', div({ [CACHE_REMOVED_CHILDREN]: 2 }, () => s.list.map((item) => p({ id: item, $color: null, onclick: () => { } }, item))), { [UID_ATTR_NAME]: 'uid' });
            const el = document.querySelector('p');
            expect(el === null || el === void 0 ? void 0 : el.id).toBe('a');
            expect(el === null || el === void 0 ? void 0 : el.getAttribute('uid')).toBe('1');
            s.list.pop();
            expect(document.querySelector('p')).toBeNull();
            s.list.push('a');
            const el2 = document.querySelector('p');
            expect(el2 === null || el2 === void 0 ? void 0 : el2.id).toBe('a');
            expect(el2 === null || el2 === void 0 ? void 0 : el2.getAttribute('uid')).toBe('1');
        });
        it('should handle complex children update with uid', () => {
            const data = reactive({
                items: [{ id: 'a' }, { id: 'b' }, { id: 'c' }, { id: 'd', class: 'd' }],
            });
            const vel = ul(() => data.items.map((item) => li({ id: item.id, class: item.class }, item.id)));
