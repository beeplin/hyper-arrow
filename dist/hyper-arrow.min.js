...
function e(e, t, n = {}) {
  ;(q = n[R]), h, h, l(f.querySelector(e), [t]), h
}
function n(t, e) {
  return (
    y([null, null, t, e]),
              ...
              null != (s = s.get(e)) &&
                ...
                s
                  ? 'number' == typeof r ||
                    ...
                    ? ((s = null != r ? r : 0), z(i[W][s]), d(i, s, p(a)))
                    : null === r
                    ? (i[W].map(z), v(i, a.map(p)))
                    : w(i[N], r, a)
                  : null != l && l(a))
          return u
        },
          ...
          var t,
            ...
            o =
              'html' === e[$]
                ? f.createElement(e[E])
                : 'svg' === e[$]
                ? f.createElementNS('http://www.w3.org/2000/svg', e[E])
                : f.createElementNS('http://www.w3.org/1998/Math/MathML', e[E])
          for (r in (h, q && u(o, q, V++), e[O])) w(o, r, e[O][r])
          return (
            h, l(o, e[W]), null != (n = (t = e[O])[B]) && n.call(t, o), s(e, o)
          )
        }
  )(e)
}
function s(e, t) {
  return (
    (e[N] = t),
    e instanceof c && 'number' == typeof e[O][r] && a(e[W]) && (e[L] = {}),
    (t[Z] = e)
  )
}
function v(n, r) {
  var t = a(n[W]),
    o = a(r)
  if (t && o) {
    for (let e = t[b] - 1; 0 <= e; e--) o.includes(t[e]) || g(n, e)
...
function d(e, t, n) {
  ...
  if (r[$] !== S && n[$] !== S && r[E] === n[E]) {
    var o,
      l,
      i = r[N]
    for (o in n[O]) r[O][o] !== n[O][o] && w(i, o, n[O][o])
    for (l in r[O])
      if (!(l in n[O])) {
        var f = void 0,
          f = i,
          u = l,
          a = _(u)
        if (a in f.attributes) A(f, a)
        else {
          a = [...u].reduce(
            (e, t) => ('A' <= t && t <= 'Z' ? e + '-' + _(t) : e + t),
            '',
          )
          if (a in f.attributes) A(f, a)
          else if (u in K) {
    ...
    ;['innerText', 'innerHTML', 'textContent'].some((e) => e in n[O]) ||
      v(r, n[W]),
      (e[W][t] = s(n, r[N]))
  } else g(e, t), m(e, t, n)
}
function m(e, t, n) {
  ...
  r.insertBefore(o, r.childNodes.item(t)),
    h,
    e[W].splice(t, 0, n),
    e[L] && ((o = n[O].id), h && 0 in e[L], delete e[L][o])
}
function g(e, t) {
  var n,
    t = e[W].splice(t, 1)[0]
  return (
    ...
    e[L] &&
      null != e[O][r] &&
      P.keys(e[L]).length < e[O][r] &&
      ((n = t[O].id), h && 0 in t[O], (e[L][n] = t)),
    t
  )
}
function w(e, t, n) {
...
function z(e) {
  for (var t of j.keys())
    (n = t),
      (r = e),
      n[F] && r[N].contains(null == (r = n[F]) ? void 0 : r[N]) && j.delete(t)
  var n, r
}
let h = !0,
  b = 'length',
            ...
            get: (e, t) =>
              function (e, t, ...n) {
                ...
                var r,
                  ...
                  [i, e] =
                    'object' != typeof n[0] || x(n[0]) || n[0] instanceof c
                      ? [{}, n]
                      : [n[0], M(n)]
                ...
                var f = y([
                  l,
                  null,
                  x(e) && 1 === e[b] && ('function' == typeof e[0] || x(e[0]))
                    ? e[0]
                    : e,
                ])
                if (
